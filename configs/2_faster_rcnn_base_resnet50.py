...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        type=dataset_type,
        data_root=data_root,
        ann_file="train_sample.json",    ### bitirme
        data_prefix=dict(img="train_images_aug/"),    ### bitirme
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        type=dataset_type,
        data_root=data_root,
        ann_file="val.json",    ### bitirme
        data_prefix=dict(img="val_images/"),    ### bitirme
        test_mode=True,
...
#         type=dataset_type,
#         data_root=data_root,
#         ann_file="test.json",    ### bitirme
#         data_prefix=dict(img="test_images/"),    ### bitirme
#         test_mode=True,
#         pipeline=test_pipeline))
# test_evaluator = dict(
#     type='CocoMetric',
#     metric='bbox',
#     format_only=True,
#     ann_file=data_root + "test.json",    ### bitirme
